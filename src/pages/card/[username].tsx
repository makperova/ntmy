...
import { getCardByUsername } from '../../components/CardLocalStorage';
...
const CardPage: NextPage<CardPageProps> = ({ card, error, statusCode, debug }) => {
  ...
  // Используем только карточку из MongoDB
